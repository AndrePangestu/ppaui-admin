...
if ( ! function_exists('generatehtml'))
{
	...
	function inputan($type,$names,$class,$placeholder,$required,$values,$tags)
        {       
            ...
            return "<div class='$class'><input type='$type' autocomplete='off' name='$names' placeholder='$placeholder' class='form-control' $requred value='$values' $tagtemp ></div>";
        }
    ...
    //function checked($checked,$current,$echo)
	//{
	//	return "<checked name='$name' current='$current' echo='$echo'>";
	//}

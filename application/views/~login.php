...
<html>
  <head>
	...
	body {
		background-size: 100%;
		background-image: url(/pelatihan_ppa/assets/images/background.jpg);
	}
</style>
      ...
      <div class="container">
          ...
          <div class="col-md-5">
			...
			<br><br><br><br><br>	  
              <table class="table">
              <tr>
                <td width="160" rowspan="6" align="center"><img src="/pelatihan_ppa/assets/images/PPALOGO.png" width="100" height="160"></td>
			  ...
			  <tr><td><?php echo $image;?></td><td>
                      <div class="col-md-12">
                          <input type="text" name="kode_aman" placeholder="Masukan 5 Huruf" required="" class="form-control"></div>
                  </td></tr>

...
<table>
    <tr><td width="100">NIP</td><td>: <?php echo strtoupper($biodata['nim'])?></td></tr>
     <tr><td>NAMA</td><td>: <?php echo strtoupper($biodata['nama'])?></td></tr>
      <tr><td>ANGKATAN</td><td>: <?php echo strtoupper($biodata['nama_konsentrasi'])?></td></tr>
</table>
...
<br><br>
Depok, <?php echo tgl_indo(substr(waktu(), 0,10))?><br>

...
<h3>LAPORAN KEUANGAN PPA FEB UI</h3>
...
<table  border="1" cellspacing="0" width="600">
    <tr><td width="140">TAHUN PELATIHAN</td><td>: <?php echo strtoupper(getField('student_angkatan', 'keterangan', 'angkatan_id', $t->angkatan_id))?></td></tr>
...
<table border="1" cellspacing="0" bordercolor="#7E7E7E">
    <tr><th rowspan="2">No</th><th rowspan="2">NIP</th><th rowspan="2" width="150">NAMA</th>
    <?php
    ...
    foreach ($jenis_bayar->result() as $j)
    {
        echo "<th width='50'>Terbayar</th><th  width='50'>Piutang</th>";
    }
    ?>
    </tr>
    <?php

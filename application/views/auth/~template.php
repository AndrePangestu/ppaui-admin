...
<html lang="en">
  ...
  <body>
                        ...
                        <div class="collapse navbar-collapse navbar-ex1-collapse">
                            <ul class="nav navbar-nav">
                              <li class="active"><a href="javascript:void(0)"> <i class="fa fa-barcode"></i> Link</a></li>-->
                                <?php
                                $mainmenu=$this->db->get_where('mainmenu',array('aktif'=>'y','group_id'=>$this->session->userdata('group_id')))->result();
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo strtoupper($this->session->userdata('id_users'));?> <b class="caret"></b></a>
                                    <ul class="dropdown-menu">
     ...
     <div class="container" style="background: white;">
      ...
      <hr>
      <p align='center' style="font-weight: bold;" >&copy; SISFO | PPA FEB UI 2015</p>
